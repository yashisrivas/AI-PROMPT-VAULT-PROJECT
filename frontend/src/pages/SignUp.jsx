    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-md relative">
                ...
                <div className="absolute -top-20 -right-20 w-44 h-44 bg-fuchsia-600/20 rounded-full blur-[80px]"></div>
                <div className="absolute -bottom-20 -left-20 w-44 h-44 bg-violet-600/30 rounded-full blur-[80px]"></div>
                ...
                <div className="relative text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black text-white tracking-tight mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Join the Vault</h1>
                    <p className="text-gray-400 font-medium">Secure your ideas in the nebula.</p>
                </div>
                ...
                <div className="relative bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden">
                    ...
                    {success && (
                        <div className="mb-6 p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm font-medium animate-pulse">
                            {success}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-5 py-3 rounded-2xl bg-black/40 border border-white/5 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all"
                            />
                        </div>
                        <div>
                    ...
                    <p className="text-center text-sm text-gray-400 mt-8">
                        ...
                        <Link to="/login" className="text-violet-400 hover:text-fuchsia-400 font-bold transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
